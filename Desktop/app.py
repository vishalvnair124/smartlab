...
CTkLabel(master=frame, text="  Session", text_color="#601E88", anchor="w", justify="left", font=("Arial Bold", 14), image=session_icon, compound="left").pack(anchor="w", pady=(21, 0), padx=(25, 0))
CTkEntry(master=frame, width=225, fg_color="#EEEEEE", border_color="#601E88", border_width=1, text_color="#000000").pack(anchor="w", padx=(25, 0))
